...
(function () {
  ...
  var THEMES = window.devboardThemes.THEMES;
  // 颜色工具同样来自共享模块：与 :root 生成器（scripts/sync-theme-root.js）同一份实现，派生阶梯两处一致
  var hexToRgb = window.devboardThemes.hexToRgb;
  var mixHex = window.devboardThemes.mixHex;
  var rgbaOf = window.devboardThemes.rgbaOf;
